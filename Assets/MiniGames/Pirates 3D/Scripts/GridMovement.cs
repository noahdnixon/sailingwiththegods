...
public class GridMovement : MonoBehaviour
{
	...
	//List that show tiles the player can select for attack after movement
	...
	//Default moves per turn, speed of moves, Attack Range, Attack Damage, and flags for player moving and if the player has moved
	//Additions - Attack Range, Attack Damage, flag for is the player has moved
	public int move = 5;
	...
	public void CalculateAdjacentAttackLists(Tile target) 
	{
		foreach (GameObject tile in tiles) 
		{
			Tile t = tile.GetComponent<Tile>();
			//t.FindTargets(target);
		}
	}
